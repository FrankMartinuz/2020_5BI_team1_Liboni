...
**Project Title:** ServerChat

**Start Date:**

**End Date:** 12/07/2010

**Project Manager:** _David Haney_

**Project Sponsor:** _UMKC_

**Customer:** _Ronald, Vishal_

**Users:** _UMKC Students_

**Stakeholders and Expectations:**

Team: _Have ready access to individuals with the authority to make decisions regarding software requirements. Be given specific and detailed feedback on product increments._

Professor Burris: _Have a cool app to show to the department at project end_.

UMKC: _Gain mobile visibility with an app students can use to enhance their UMKC experience._

**Purpose (Problem or opportunity addressed by the project)**:

Students who take advantage of the Roo Bucks program will have a quick and easy way to keep on top of their available funds.  Currently students must go online or check their balance with the One Card office.  Adding a mobile app to the available methods will allow Roo Bucks users to check their balance at any time and place they have smartphone connectivity.
